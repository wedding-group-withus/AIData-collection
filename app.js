...
const AIAdviceData = {
  peak: {
    golden: [
      ...
      {
        targetId: 'patiobella',
        advice: `"파티오벨라 안양은 범계역 역세권과 1층 일직선 동선이 편리하나 복도와 로비가 다소 콤팩트하여 하객이 겹칠 시 정체가 심합니다. 위더스의 웅장한 층고와 층별로 완벽 격리된 단독 로비의 쾌적함을 비교하여 품격을 설득하십시오."`,
        nextMoveText: "파티오벨라의 단층 복도 혼잡 제약과 층고를 대조 설명하기 위한 '상담 대본'을 사용하시겠습니까?",
        nextMoveAction: () => openScriptModal('patiobella')
      },
      {
        targetId: 'partyum',
    ...
    regular: [
      ...
      {
        targetId: 'patiobella',
        advice: `"파티오벨라는 1층 동층 연회장을 사용해 동선이 심플하지만, 하우스식 공간의 한계로 천장고가 낮아 하객 답답함이 있을 수 있습니다. 날씨 리스크 없고 웅장한 극장식 스타일의 위더스 메리엘홀과 긴 버진로드를 대조 제안하십시오."`,
        nextMoveText: "파티오벨라의 낮은 층고 및 하우스홀 규격 제약을 대조하는 '상담 대본'을 사용하시겠습니까?",
        nextMoveAction: () => openScriptModal('patiobella')
      },
      {
        targetId: 'partyum',
  ...
  offPeak: {
    ...
    regular: [
      ...
      {
        targetId: 'patiobella',
        advice: `"비수기 일반타임 상담입니다. 파티오벨라의 지상/지하 주차장은 입출차 통로 진입 각도가 좁아 주말 차량 병목 현상이 발생하기 쉽습니다. 위더스만의 단독 주차타워 1,000대 즉시 주차 메리트를 적극 소개하여 접근 편의를 비교 제안하십시오."`,
        nextMoveText: "파티오벨라 주차 통로 진입 정체 및 우려사항을 대조 설명하는 '상담 대본'을 사용하시겠습니까?",
        nextMoveAction: () => openScriptModal('patiobella')
      },
      {
        targetId: 'villadegd',
...
function triggerWaveformPulse() {
  ...
  setTimeout(() => {
    aiVoiceStatus.textContent = "상담 조건에 맞춰 최선의 상담 전략과 가격 우위 제안을 분석 중입니다.";
